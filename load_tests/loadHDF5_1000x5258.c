/* loadHDF5_chunked.c, 9aug2017, from: loadHDF5.c, 1jul2016, from... example code h5_crtdat.c etc.  */
...
/* Load one dataset in Intermediate File format into the specified HDF5 file. 
   ...
   Chunking 1000 markers x 5258 (all) samples.
*/
...
int main(int argc, char *argv[]) {
  ...
  if (argc < 4) {
    ...
    printf("Example: %s 1 /shared_data/NAM_HM32/ifl/chr06/x00.ifl  /shared_data/NAM_HM32/NAM_1000x1000.h5\n", argv[0]);
    printf("Example: %s 1 /shared_data/NAM_HM32/ifl/chr06/x01.ifl  /shared_data/NAM_HM32/NAM_1000x1000.h5\n", argv[0]);
