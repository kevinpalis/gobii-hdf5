/* fetchsamplelist_test.c, 24apr2017, from fetchsamplelist.c, 8jun2016, from fetchsample.c, 7may16, from: samplestest.c, 26jan2015
...
int main (int argc, char *argv[]) {
  ...
  if (argc < 4) {
    ...
    printf("E.g. %s /local/data/NAM_HM32/NAMc6-10.h5 ./samplelist 1000 /local/data/NAM_HM32/fetchsamplelist.out\n", argv[0]);
