/* fetchmarkerlist_test.c, 26apr17, from fetchmarkerlist.c, 8jun16, from fetchmarker.c, 7may16
...
int main (int argc, char *argv[]) {
  ...
  if (argc < 5) {
    printf("Usage: %s <HDF5 file> <listfile> <markercount> <output file>\n", argv[0]);
    printf("E.g. %s /local/data/NAM_HM32/NAMc6-10.h5 ./markerlist 1000 /local/data/NAM_HM32/fetchmarkerlist.out\n", argv[0]);
