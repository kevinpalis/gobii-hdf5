/* fetchmarkerblock_indel_lkp2.c, 30nov19, from: */
...
/* 30nov19, Read the insertions file into an array, just one read. */
...
int main (int argc, char *argv[]) {
  ...
  FILE *outfile;
  int datumsize, i, j, k, s;

  if (argc < 6) {
    printf("Usage: %s <HDF5 file> <inserts file> <firstmarker> <markercount> <output file>\n", argv[0]);
    printf("E.g. %s ../data/generated_dataset_indels100.lkp.h5 ../data//generated_dataset_indels100.lkp.h5.inserts 5000017 1000 ./fetchmarkerblock.out\n", argv[0]);
